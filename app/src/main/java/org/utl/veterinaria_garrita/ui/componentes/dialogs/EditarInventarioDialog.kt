...
fun EditarInventarioDialog(
    ...
    var nombreProducto by remember { mutableStateOf(inventario.nombreProducto) }
    var descripcion by remember { mutableStateOf(inventario.descripcion) }
    var cantidad by remember { mutableStateOf(inventario.cantidad.toString()) }
    var precio by remember { mutableStateOf(inventario.precio.toString()) }
    var categoria by remember { mutableStateOf(inventario.categoria) }
    var errorMessage by remember { mutableStateOf("") }

    AlertDialog(
        onDismissRequest = onDismiss,
        title = { Text("Editar item del inventario") },
        text = {
            Column {
                OutlinedTextField(
